...
\begin{tabular}{| p{10mm} | p{8mm} | p{12mm} | p{8mm} | p{54mm} | p{64mm} | p{66mm} | p{47.74mm} |}
  ...
  1\N & & & 4\H                   & \makecell[tl]{a) 14--16 BAL \nth{1}, \nth{2}, \nth{3} NV\\b) 15--17 BAL \nth{3} VUL, \nth{4}}  & Stayman, transfers, 2\S=\C\ or range ask, 2\N=\D\ or \mm\ weak, 3\C=Puppet Stayman, 3\D=\mm\ GF, 3\M=short \M\ GF, 4\C=Gerber, 4\D\H=Texas, 4\S\N=QUANT & 1\N--2\C--2\D: 2\H=weak \MM & 1\N--(2$X$ not \C): Lebensohl \ref{lebensohl} \\ \hline
 ...
 & \\ \hline
  ...
  3X & & 7 (6) & & preemptive, (0)3--9 &  &  & \\ \hline
  3\N & \centering\tick & & & Gambling, 7\+\m\ with AKQ, no other A or K & \P=stoppers in all other suits, 4\C = P/C, 4\D=asks, 5\C=P/C, (5\D = to play) & 4\D: 4\M=0/1 \M, 4\N = 22(72), 5\m = 0/1 other \m & \\ \hline
  4\m & & 8 (7) & & preemptive, (0)3--9 &  &  & \\ \hline
  4\M & & 7 & & to play &  &  & \\ \hline
