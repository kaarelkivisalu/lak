...
\small
  \begin{adjustbox}{valign=t,minipage={90mm}}
    \begin{tabular}{|p{88mm}|}
      ...
      T/O \X\ thru 4\D, (2$X$)--\X: Lebensohl\\
...
\setlength{\lineskip}{0pt}
  ...
  \begin{tabular}{| p{88mm} |}
    ...
    (1\M)--\X--(\P)--2\C--2\D=Equal Level Conversion,\\
    \phantom{(1\M)--\X--(\P)--2\C--2\D=}o\M\ and \D\\
    \\
    \\
    \\
    \\
...
\begin{tabular}{| p{10mm} | p{8mm} | p{12mm} | p{8mm} | p{54mm} | p{64mm} | p{66mm} | p{47.74mm} |}
  ...
  & \makecell[tl]{1\D: 1\H=20\+\\2\S: 2\N=asks (3X=short X)}
  ...
  & 1\M=4\+\M\ 6\+, 1\N=7--11, 2\m=5\+\m\ INV F1, 2\H/\S=5\S4\+\H\ below INV/INV, 2\N=INV, 3\m=INV, 3\N=to play, other=PRE
  & 1X--1Y--1Z: 2\C=puppet to 2\D (INV or long \D), 2\D=art GF, 2\M=NF
  & \\ \hline

  1\H & & 5 (4 \nth{3}) & 4\D
  & \makecell[tl]{10--15, 5\+\H,\\can be 4\H\ and/or light in \nth{3}}
  & 2\m=4\+\m\ GF, 2\N=INV or slam try, 3\+\H
  & \makecell[tl]{2\N: 3\m\S=shortness, not MIN, 3\H=MIN,\\4\m=MAX 5\+\m, 3\N=MAX,\\ 5\H(332), 4\H=MAX BAL 6\+\H\\ 1\H--1\S--1\N: 2\C=puppet to 2\D (INV or\\ long \D), 2\D=art GF, 2\M=NF}
  & \\ \hline

  1\S & & 5 (4 \nth{3}) & 4\H
  & \makecell[tl]{10--15, 5\+\S,\\can be 4\S\ and/or light in \nth{3}}
  & 2\m=4\+\m\ GF, 2\H=5\+\H\ GF, 2\N: INV or slam try 3\+\S
  & \makecell[tl]{2\N: 3\m/\H=shortness, not MIN, 3\S=MIN,\\ 3\N=MAX, 5(332), 4\m/\H=MAX, 5\+ card,\\ 4\S=MAX BAL 6\+\S}
  & \\ \hline

  1\N & & & 4\H
  & \makecell[tl]{a) 14--16 BAL \nth{1}, \nth{2}, \nth{3} NV\\b) 15--17 BAL \nth{3} VUL, \nth{4}}
  & Stayman, transfers, 2\S=\C\ or range ask, 2\N=\D\ or \mm\ weak, 3\C=Puppet Stayman, 3\D=\mm\ GF, 3\M=short \M\ GF, 4\C=Gerber, 4\D\H=Texas, 4\N=QUANT
  & 1\N--2\C--2\D: 2\H=weak \MM & 1\N--(2$X$ not \C): Lebensohl \\ \hline

  2\C & & 6 & 4\H
  & 10--15, 6\+\C
  & 2\D=ask, 2\M=NF, 2\N=puppet to 3\C\ (to play or 55 GF), 3\C\D\H=INV\+ in \D\H\S, 3\S=6\S4\H~GF
  & 2\D: 2\M=MIN, 4\M, 2\N=MAX, no 4 card major, 3\C=MIN, no 4 card major, 3\D\H\S=MAX, 4\+ suit
  & \\ \hline
  ...
  2\N & & & 4\H & \makecell[tl]{a) 19--20 BAL \nth{1}, \nth{2}, \nth{3} NV\\b) 20--21 BAL \nth{3} VUL, \nth{4}} & \makecell[tl]{Muppet Stayman, transfers, 3\S=54\+\mm\ or\\ 6\+\m\ mild S/T+, 4\C=Gerber,\\ 4\D\H=6\+\M, S/T, 4\S/\N=QUANT} & & \\ \hline
...
\begin{tabular}{| p{141.29mm} | p{141.29mm} |}
  ...
  Roman Keycard Blackwood 1430, Kickback, Serious 3\N.&\\
  % \rule{0pt}{17.9pt} & \\
  \hline
\end{tabular}
